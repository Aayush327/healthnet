...
class Profile(models.Model):
    ...
    prefHospital = models.ForeignKey('Hospital',on_delete=models.PROTECT, null=True)
...
class Appointment(models.Model):
    doctor = models.ForeignKey(User,on_delete=models.PROTECT, related_name="doctors")
    patient = models.ForeignKey(User,on_delete=models.PROTECT, related_name="patients")
...
class Message(models.Model):
    target = models.ForeignKey(Account,on_delete=models.PROTECT, related_name="messages_received")
    sender = models.ForeignKey(Account,on_delete=models.PROTECT, related_name="messages_sent")
...
class Notification(models.Model):
    user = models.ForeignKey(Account,on_delete=models.PROTECT, related_name="notifications_all")
...
class Admission(models.Model):
    patient = models.ForeignKey(User,on_delete=models.PROTECT, related_name="patients1")
...
class MedicalInfo(models.Model):
    ...
    patient = models.ForeignKey(User,on_delete=models.PROTECT, related_name="patiento")
...
class MedicalTest(models.Model):
    ...
    hospital = models.ForeignKey(Hospital,on_delete=models.PROTECT)
    description = models.CharField(max_length=200)
    doctor = models.ForeignKey(User,on_delete=models.PROTECT, related_name="docs")
    patient = models.ForeignKey(User,on_delete=models.PROTECT, related_name="pts")
